...
从 [Releases](https://github.com/ChuckChouCn/x-twitter-post-embed/releases) 下载 `main.js`、`manifest.json`、`styles.css` 三个文件，放进 vault 的 `.obsidian/plugins/x-embed-sync/`，在「设置 → 第三方插件」里启用即可。
